      public async Task<IActionResult> CoordinatorMaster(Guid? id, AppCoordinatorMaster coordinatorMaster, int page = 1, string searchString = "")
      {
          ...
          if (!string.IsNullOrEmpty(UserId))
          {
              ...
              var allowedPnos = context.AppPermissionMasters
                       .Select(x => x.Pno)
                       .ToList();
              ...
              {
                  query = query.Where(p => p.Pno.Contains(searchString));
              }

              var data = query.ToList().OrderBy(loc => loc.Pno);
      ...
      [HttpPost]
      public async Task<IActionResult> CoordinatorMaster(Guid? Id)
      {
    ...
    public partial class AppCoordinatorMaster
    {
