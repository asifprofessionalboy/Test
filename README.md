...
BL
   ...
   public DataSet Get_Mis_Data( int intMonth, int intYear, int nextMonth, int nextYear, string monthStr, string nextMonthStr, string startDate, string endDate, string locationFilter, string departmentFilter)
   {
       string strQuery =
                    $@"
